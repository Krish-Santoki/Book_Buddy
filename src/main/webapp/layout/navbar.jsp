	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item active"><a class="nav-link active"
					aria-current="page" href="allRecentBooks.jsp">Recent</a></li>
				<li class="nav-item active"><a class="nav-link active"
					aria-current="page" href="allNewBooks.jsp">New Books</a></li>
				<li class="nav-item active"><a class="nav-link active"
					aria-current="page" href="allOldBooks.jsp">Old Books</a></li>

			</ul>
			<form class="d-flex">
				<a href="setting.jsp" class="btn btn-light my-2 my-sm-0" ><i class="fa-solid fa-gear"></i> Settings</a>
				<button class="btn btn-light my-2 my-sm-0 ms-1" type="submit"><i class="fa-solid fa-phone"></i> Contact Us</button>
				<c:if test="${not empty userobj}">
				<a href="cart.jsp" style="color: white;"><i class="fa-solid fa-cart-shopping fa-2x"></i></a>
				</c:if>
			</form>
		</div>
	</div>
